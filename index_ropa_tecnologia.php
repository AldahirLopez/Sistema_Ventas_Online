...
<html lang="en" dir="ltr">
  ...
  <header>
    ...
    <!--==card===========================-->   
          ...
          $resultado=$conexion ->query("select * from items where cantidad >= 1 and sub_categoria = 'tecnologia' limit 0,20" ) or die($conexion -> error);
    ...
    <!--==card===========================-->   
          <?php
          include ('registros/conexion.php');
          $resultado=$conexion ->query("select * from items where cantidad >= 1 and sub_categoria = 'tecnologia' limit 20,40" ) or die($conexion -> error);
          while($fila = mysqli_fetch_array($resultado)){         
          ?>
                    <li class="item-a">
                    <div class="product-box">
    ...
    <!--==card===========================-->   
          <?php
          include ('registros/conexion.php');
          $resultado=$conexion ->query("select * from items where cantidad >= 1 and sub_categoria = 'tecnologia' limit 40,100" ) or die($conexion -> error);
          while($fila = mysqli_fetch_array($resultado)){         
          ?>
                    <li class="item-a">
                    <div class="product-box">
