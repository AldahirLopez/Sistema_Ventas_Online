  ...
  <body>
    ...
    <section class="products-slider">
        ...
        <div class="slider-heading">
            <h3> Buscando resultados para <span> <?php echo $_GET['texto']?>.</span></h3>
        </div>
        <!--product-container---------------------->
    ...
    <!--==card===========================-->   
          ...
          include ('registros/conexion.php');
          $resultado=$conexion ->query("select * from items where 
          nombre like '%".$_GET['texto']."%' or
          precio like '%".$_GET['texto']."%' or
          descripcion like '%".$_GET['texto']."%' or 
          categoria like '%".$_GET['texto']."%' or 
          sub_categoria like '%".$_GET['texto']."%' or 
          talla  like '%".$_GET['texto']."%' 
          and cantidad >= 1") or die($conexion -> error);
