...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <!--==card===========================-->   
          ...
          $resultado=$conexion ->query("select * from items where cantidad >= 1 and  categoria = 'ropa' and sub_categoria = 'hoodies' limit 0,20 ") or die($conexion -> error);
...
<section class="products-slider">
    ...
    <!--==card===========================-->   
          <?php
          include ('registros/conexion.php');
          $resultado=$conexion ->query("select * from items where cantidad >= 1 and  categoria = 'ropa' and sub_categoria = 'hoodies' limit 20,40 ") or die($conexion -> error);
          while($fila = mysqli_fetch_array($resultado)){         
          ?>
                    <li class="item-a">
                    <div class="product-box">
...
<section class="products-slider">
    ...
    <!--==card===========================-->   
          <?php
          include ('registros/conexion.php');
          $resultado=$conexion ->query("select * from items where cantidad >= 1 and  categoria = 'ropa' and sub_categoria = 'hoodies' limit 40,100 ") or die($conexion -> error);
          while($fila = mysqli_fetch_array($resultado)){         
          ?>
                    <li class="item-a">
                    <div class="product-box">
